...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
      <div class="card">
          ...
          <div class="card-body">
              <center><a href="{{Route('dashboard.index')}}" class="btn btn-lg btn-info">N-Recibo</a></center>
          </div>
      </div>
  </div>
  <div class="col">
      <div class="card">
          ...
          <div class="card-body">
              <center><a href="{{Route('dashboard.index')}}" class="btn btn-lg btn-info">Reporte diario</a></center>
          </div>
      </div>
  </div>
  <div class="col">
      <div class="card">
          ...
          <div class="card-body">
              <center><a href="{{Route('dashboard.index')}}" class="btn btn-lg btn-info">Ingresos Totales</a></center>
          </div>
      </div>
  </div>
</div>
