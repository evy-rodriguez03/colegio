...
class PadreStoreTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $response = $this->get('/padres/crear');
    ...
    public function test_paraVerificarVistaCorrecta()
    {
        ...
        $response->assertViewIs('secretaria.Padres.datos_padre');
    }
    ...
    public function testPrimernombreVacio()
    {
        ...
        $response = $this->post('/padres', $padreData);
